ActiveAdmin.register CaseStudy do
  ...
  form html: { multipart: true} do |f|
    ...
    f.has_many :case_study_images, heading: "Detail Images. Provide 3 to trigger the new layout for Martin. (Or just 2 if this case study has a youtube ID above). In all cases make sure to provide a banner image at the top of this form.", new_record: "Add an image" do |csi|
