class DistributorInfo::Admin::DistributorBrandsController < DistributorInfo::AdminController
        ...
        begin
          @distributor_brands.each do |distributor_brand|
            begin
              ...
              add_log(user: current_user, action: "Associated #{distributor_brand.distributor.name} with #{distributor_brand.brand.name}")
              format.js
            rescue => e
  ...
  def update
    respond_to do |format|
      if @distributor_brand.update(distributor_brand_params)
  ...
  def update_order
    ...
    head :ok
    add_log(user: current_user, action: "Sorted distributor brands")
  end     
