...
ActiveRecord::Schema[7.1].define(version: 2024_06_26_214658) do
  ...
  create_table "brands", id: :integer, charset: "latin1", force: :cascade do |t|
    ...
    t.datetime "by_harman_logo_updated_at", precision: nil
    ...
    t.datetime "logo_collection_updated_at", precision: nil
  ...
  create_table "influencers", charset: "utf8", force: :cascade do |t|
    ...
    t.datetime "social_media_deck_updated_at", precision: nil
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  end
  ...
  create_table "reference_systems", id: :integer, charset: "latin1", force: :cascade do |t|
    ...
    t.datetime "system_diagram_updated_at", precision: nil
  ...
  create_table "slides", id: :integer, charset: "utf8", force: :cascade do |t|
    ...
    t.datetime "bubble_updated_at", precision: nil
    t.string "headline"
    t.string "description"
    t.string "link_text"
    t.string "link_url"
  ...
  create_table "vertical_markets", id: :integer, charset: "latin1", force: :cascade do |t|
    ...
    t.datetime "hef_banner_updated_at", precision: nil
    t.string "preview_code"
